...
$BASE = $BASE ?? ''; // optional, not used for assets below
...
// ---- LOGIN CHECK (giữ yêu cầu phải đăng nhập; bỏ guardProjectsAccess để luôn bật tính năng Project)
$userId = $_SESSION['user_id'] ?? 0;
if (!$userId) {
  header('Location: /index.php'); // sửa nếu index.php của bạn nằm nơi khác
  exit;
}
